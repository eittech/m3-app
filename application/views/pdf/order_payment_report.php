...
$this->pdf->Cell(25,15,"Fecha.",'LTB',0,'C',1);
$this->pdf->Cell(25,15,"ID.",'TB',0,'C',1);
$this->pdf->Cell(25,15,"Metodo de pago",'TB',0,'L',1);
$this->pdf->Cell(25,15,"Nro de Referencia",'TB',0,'L',1);
$this->pdf->Cell(25,15,"Monto",'TB',0,'C',1);
$this->pdf->Cell(70,15,"Observaciones",'TRB',1,'C',1);

foreach ($order_payment as $key => $value) {
	$this->pdf->SetFillColor(255,255,255);
	$this->pdf->SetTextColor(0,0,0); # COLOR DEL TEXTO
	$this->pdf->SetFont('Arial','',7);
	$this->pdf->Cell(25,15,$value->date_add,'LTB',0,'C',1);
	$this->pdf->SetFont('Arial','',8);
	$this->pdf->Cell(25,15,$value->id_order_payment,'TB',0,'C',1);
	$this->pdf->Cell(25,15,$value->payment_method,'TB',0,'L',1);
	$this->pdf->Cell(25,15,$value->transaction_id,'TB',0,'L',1);
	$this->pdf->Cell(25,15,number_format((float)$value->amount, 2, ',', '.'),'TB',0,'C',1);
	$this->pdf->Cell(70,15,"Observaciones",'LTBR',1,'C',1);
}
